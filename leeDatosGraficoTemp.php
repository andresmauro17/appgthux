...
/*
 * leeDatosGraficoTemp devuelve las últimas lecturas por la nevera especificada y el día actual.
 * */
$idNevera= $_GET["id"];
$fec1 = $_GET["fec1"];
$fec2 = $_GET["fec2"];
...
$query			= mysql_query("CALL graficotemp(".$idNevera.",'".$fec1."','".$fec2."');"); // Check the table for actual day only
